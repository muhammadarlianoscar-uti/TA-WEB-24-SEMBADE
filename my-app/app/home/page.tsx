    ...
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 flex items-center justify-center min-h-[80vh]">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10 pt-10">
          ...
          <p className="mt-4 text-xl md:text-2xl max-w-3xl mx-auto text-emerald-50 mb-10 leading-relaxed drop-shadow-md">
            Mewujudkan tata kelola desa yang transparan, inovatif, dan
            terintegrasi melalui teknologi digital untuk kesejahteraan
            masyarakat.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl p-8 transition-all duration-300 hover:-translate-y-2 border border-slate-100">
            ...
            <p className="text-slate-600 mb-6 line-clamp-3">
              Urus surat pengantar, keterangan domisili, dan dokumen
              administrasi lainnya secara cepat tanpa perlu antre di balai desa.
            </p>
            <Link
              href="/pelayanan"
          ...
          <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl p-8 transition-all duration-300 hover:-translate-y-2 border border-slate-100">
            ...
            <p className="text-slate-600 mb-6 line-clamp-3">
              Jelajahi potensi wisata lokal, produk unggulan UMKM, dan hasil
              pertanian kebanggaan dari masyarakat desa kami.
            </p>
            <Link
              href="/potensi"
              className="text-emerald-600 font-semibold hover:text-emerald-800 flex items-center gap-1"
          ...
          <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl p-8 transition-all duration-300 hover:-translate-y-2 border border-slate-100">
            ...
            <p className="text-slate-600 mb-6 line-clamp-3">
              Dapatkan informasi terbaru mengenai kegiatan desa, pengumuman
              penting, dan transparansi dana alokasi desa.
            </p>
            <Link
              href="/berita"
              className="text-emerald-600 font-semibold hover:text-emerald-800 flex items-center gap-1"
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <h2 className="text-3xl font-bold text-emerald-800">
              Potret Keindahan Desa
            </h2>
            <div className="w-16 h-1 bg-emerald-500 mt-4 rounded-full"></div>
            <p className="mt-4 text-slate-600 max-w-2xl">
              Jelajahi sudut-sudut inspiratif, kegiatan warga, dan pesona alam
              yang menjadi kebanggaan kita bersama.
            </p>
          </div>
          {/* shrink-0 = mencegah tombol teks ini tertekan/menyusut ukurannya saat layar mengecil */}
          <Link
            href="/potensi"
            className="text-emerald-600 font-medium hover:text-emerald-800 flex items-center gap-1 shrink-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 h-auto md:h-[600px]">
          ...
          <div className="group relative overflow-hidden rounded-2xl md:col-span-2 md:row-span-2 shadow-md hover:shadow-xl transition-all duration-300 h-64 md:h-full">
            ...
            <div className="absolute bottom-0 left-0 p-6 translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
              <span className="bg-emerald-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-3 inline-block">
                Alam
              </span>
              <h3 className="text-2xl font-bold text-white mb-2">
                Area Persawahan Terasering
              </h3>
              <p className="text-emerald-50 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
                Hamparan hijau yang menjadi sumber utama komoditas agrikultur
                desa.
              </p>
            </div>
          </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl md:col-span-2 shadow-md hover:shadow-xl transition-all duration-300 h-48 md:h-full">
            ...
            <div className="absolute bottom-0 left-0 p-5 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
              ...
              <p className="text-emerald-50 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                Tradisi tahunan wujud syukur masyarakat.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4">
          ...
          <Link
            href="/agenda"
            className="text-emerald-600 font-semibold hover:text-emerald-800 text-sm"
          >
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col sm:flex-row items-start sm:items-center gap-6 hover:shadow-md transition-shadow">
            ...
            <div className="flex-1">
              ...
              <h3 className="text-xl font-bold text-slate-800 mt-2 mb-1">
                Rapat Koordinasi Pembangunan Desa (Musrenbang)
              </h3>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 flex flex-col sm:flex-row items-start sm:items-center gap-6 hover:shadow-md transition-shadow">
            ...
            <div className="flex-1">
              ...
              <h3 className="text-xl font-bold text-slate-800 mt-2 mb-1">
                Posyandu Serentak & Sosialisasi Gizi Sehat Anak
              </h3>
              <p className="text-slate-500 text-sm flex items-center gap-4">
